...
// idle
void OffensiveAI::IdleState::step(float dt, Vision::Results* visionResults, float totalDuration, float stateDuration) {
	if (ai->running) {
...
void OffensiveAI::FindBallState::step(float dt, Vision::Results* visionResults, float totalDuration, float stateDuration) {
